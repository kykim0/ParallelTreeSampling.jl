# Generic DiscreteNonParametric with symbol support.
...
Distributions.support(d::GenericDiscreteNonParametric) = d.support

Distributions.probs(d::GenericDiscreteNonParametric)  = d.distribution.p
